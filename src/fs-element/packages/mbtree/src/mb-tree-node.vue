<template>
  <div class="el-tree-node"
    ...
    <div class="el-tree-node__content"
      ...
      <span style="float:right;" @click.stop="handleExpandIconClick" v-show="!node.isLeaf">
        <i class="el-icon-caret-right" style="color:#97a8be ;cursor:pointer" ></i>
      </span>
    </div>
  </div>
</template>
...
<script type="text/jsx">
  import ElCollapseTransition from 'ifbp-element/src/transitions/collapse-transition';
        ...
        render(h) {
          ...
          return (
            parent.renderContent
              ...
              : <span class="el-tree-node__label" style="float:left;">{ this.node.label }</span>
          );
        }
      }
    },
