<template>
    <div style="padding: 10px;" id="sys-setting">
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="修改密码" name="first" v-if="passwordTabHide">
                <change-password
...
<!--            <el-tab-pane label="偏好设置" name="second" v-if="secondShow">-->
<!--                <preference-set-->
<!--                        :setting='settings'-->
<!--                        :activeName="activeName"-->
<!--                        :platform="platform"-->
...
<!--                ></preference-set>-->
<!--            </el-tab-pane>-->
<!--            <el-tab-pane label="主题设置" name="four">-->
<!--                <theme-set-->
<!--                        :setting='settings'-->
<!--                        :activeName="activeName"-->
<!--                        :platform="platform"-->
...
<!--                ></theme-set>-->
<!--            </el-tab-pane>-->
<!--            <el-tab-pane v-if="showSettingStaff && platform === 'ifbp'" label="基本信息设置" name="three">-->
<!--                <ifbp-panel-group :navbar="false" style="margin-top: 8px;" v-if="activeName === 'three'">-->
<!--                    <ifbp-panel id="settingStaff" :icons="settingStaffIcons" title="基本信息设置" :main-title="true">-->
<!--                        <ifbp-template ref="settingStaffRef" tpl-id="settingStaff" :tpl-data="settingStaffData"-->
<!--                                       :methods="settingStaffMethods" :editable="settingStaffEdit"-->
<!--                                       :form-show-message="settingStaffEdit">-->
<!--                        </ifbp-template>-->
<!--                    </ifbp-panel>-->
<!--                </ifbp-panel-group>-->
<!--            </el-tab-pane>-->
        </el-tabs>
        <ifbp-footer v-if='this.activeName != "first"'>
            <el-button type="default" @click="cancel">取消</el-button>
            <el-button class="fr" type="primary" @click="confirm">保存</el-button>
        </ifbp-footer>
    </div>
</template>
<script>
        ...
        methods: {
            ...
            confirm() {
                if (this.activeName === 'three') {
                    ...
                    this.$set(this.settings, 'userId', commonUtils.getCookie('_A_P_id') || '')
            ...
            // 获取系统设置的数据
            getSettingsData() {
                this.activeName = commonUtils.getCookie('ifbp-setting-index', this.activeName) || 'second';
                this.$http({
...
<style>
    .all-setting .ifbp-item-group.nav-bar > .ifbp-item-group-main {
        width: 100%;
    }
    ...
    .theme-default {
      background: url('../../../../assets/images/theme/theme-default.png') no-repeat center
        center/cover;
    }
    .theme-red {
